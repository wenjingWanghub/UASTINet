...
class BaseOptions():                                                                                              
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='Mural', help='name of the experiment.')                   
        parser.add_argument('--model', type=str, default='UASTINet', help='name of the model type.')                  
        ...
        parser.add_argument('--img_file', type=str, default=r'/home', help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default=r'/home')
