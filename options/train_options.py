...
class TrainOptions(BaseOptions):                                                                                                                          
    def initialize(self, parser):
        ...
        parser.add_argument('--niter', type=int, default=168000, help='# of iter with initial learning rate')                                
        ...
        parser.add_argument('--lr_policy', type=str, default='lambda', help='learning rate policy[lambda|step|exponent]')                                                  
